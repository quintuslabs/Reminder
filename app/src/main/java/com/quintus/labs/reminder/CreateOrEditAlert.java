...
public class CreateOrEditAlert extends AppCompatActivity {
    ...
    private static final String QUATERLY = "Quqterly";
    private static final String HALFYEARLY = "Halfyearly";
    private static final String YEARLY = "Yearly";
    private static final String[] REPEAT_MODES =
            new String[]{NONE, HOURLY, DAILY, WEEKLY, MONTHLY, QUATERLY, HALFYEARLY, YEARLY};
